...
export default function Card() {
    return (
        <div className="w-full bg-white border border-green-200 rounded-lg shadow dark:bg-green-800 dark:border-green-700">
            <a href="/">
            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className="text-xl font-semibold tracking-tight text-green-900 dark:text-white">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <svg
                        className="w-4 h-4 text-green-200 dark:text-green-600"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 22 20"
                ...
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-green-900 dark:text-white">$599</span>
                    <a
                        href="/"
